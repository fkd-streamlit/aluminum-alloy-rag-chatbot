...
class AluminumAlloyRAG:
    ...
    def process_query(self, q: str) -> str:
        ...
        # -----------------------------
        # 系列指定（8000系 / 6000系 など）
        # ※ get_series_info は使わない
        # -----------------------------
        for series in [8000, 7000, 6000, 5000, 2000]:
            if f"{series}系" in expanded_keywords or f"{series}系" in text:
                return self.search_by_properties([str(series)])
